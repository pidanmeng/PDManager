!function(t, n, e, i) {
   ...
   o.prototype = {
      ...
      renderMenu: function(_that) {
         var t = this,
         n = "#uiContextMenu_" + this.random;
         if (! (e(n).length > 0)) {
            var t = this,
            i = '<ul class="ul-context-menu  notActive" id="uiContextMenu_' + this.random + '">';
      ...
      menuItemClick: function(t,_that) {
         var n = this,
         e = t.index();
         t.parent(".ul-context-menu").hide(),
         n.opts.menu[e].callback && "function" == typeof n.opts.menu[e].callback && n.opts.menu[e].callback(_that)
      },
      setPosition: function(t) {
         e("#uiContextMenu_" + this.random).css({
            left: t.clientX + window.pageXOffset + 2,
            top: t.clientY + window.pageYOffset + 2
         }).show()
      },
      eventBind: function() {
         var t = this;
